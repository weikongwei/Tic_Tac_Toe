...
def player_input():
    ...
    if grid[0] == 1:
        while True:
            try:
                PP1 = int(input("Player 1 please choose a non-occupied location (1-9).:"))
            except ValueError:
                print("Invalid input. Choose from (1-9):")
                continue
            else:
        ...
        while True:
            try:
                PP2 = int(input("Player 2 please choose a non-occupied location (1-9).:"))
            except ValueError:
                print("Invalid input. Choose from (1-9):")
                continue
            else:
